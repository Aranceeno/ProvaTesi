...
namespace NodeEditorFramework.Utilities 
{
	...
	public static class GUIScaleUtility
	{
		...
		public static List<Rect> currentRectStack  = new List<Rect>();
		private static List<List<Rect>> rectStackGroups = new List<List<Rect>>();

		// Matrices stack
		private static List<Matrix4x4> GUIMatrices = new List<Matrix4x4>();
		private static List<bool> adjustedGUILayout = new List<bool>();
		...
		public static void Init () 
		{
			...
			MethodInfo GetTopRect = GUIClipType.GetMethod ("GetTopRect", BindingFlags.Static | BindingFlags.NonPublic | BindingFlags.NonPublic);
			...
			var getMethod = topmostRect.GetGetMethod(true) ?? topmostRect.GetGetMethod(false);
			GetTopRectDelegate = (Func<Rect>)Delegate.CreateDelegate (typeof(Func<Rect>), GetTopRect);
			topmostRectDelegate = (Func<Rect>)Delegate.CreateDelegate (typeof(Func<Rect>), getMethod);
