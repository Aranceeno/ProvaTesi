...
[Node(false, "GHOST/Cards/Place - Final Card")]
public class PlaceFinalCard : Node
{
    public const string ID = "ghost_placeFinalCard";
    ...
    [ValueConnectionKnob("", Direction.In, "CardFinalType", NodeSide.Left, 30)]
