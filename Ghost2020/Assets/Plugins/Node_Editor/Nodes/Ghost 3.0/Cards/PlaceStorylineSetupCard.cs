...
[Node(false, "GHOST/Cards/Place - Storyline Setup Card")]
public class PlaceStorylineSetupCard : Node
{
    public const string ID = "ghost_placeStorylineSetupCard";
    public override string GetID { get { return ID; } }

    public override string Title { get { return "Place - Storyline Setup Card"; } }
    ...
    public enum Place { City, Dungeon, Garden, Palace, Road, Tower, Church,
            Stairs, Kitchen, Home, Chapel, River, Island, Cottage, Village,
            Ruin, Cave, Night, Mountain, Kindom, Sea, Prison, Forest, Labyrint,
            Castle, Inn, Day, Farm, Market, Bed, ForeignLand, Grave, Well, Field }
    public Place pl = Place.City;

    public enum Aspect { Cursed, Disguised, Evil, Hidden, Insane, Invisible, Lost,
            Poisoned, Stolen, CanFly, CanTalk, Beautiful, Secret, FarAway, Ugly,
            Dying, Empty, Haunted, Diseased, None }
