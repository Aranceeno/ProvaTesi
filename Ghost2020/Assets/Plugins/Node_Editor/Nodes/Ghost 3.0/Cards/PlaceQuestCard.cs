...
[Node(false, "GHOST/Cards/Place - Quest Card")]
public class PlaceQuestCard : Node
{
    public const string ID = "ghost_placeQuestCard";
    public override string GetID { get { return ID; } }

    public override string Title { get { return "Place - Quest Card"; } }
