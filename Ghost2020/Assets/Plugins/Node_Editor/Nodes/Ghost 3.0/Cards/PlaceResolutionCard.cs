...
[Node(false, "GHOST/Cards/Place - Resolution Card")]
public class PlaceResolutionCard : Node
{
    public const string ID = "ghost_placeResolutionCard";
    public override string GetID { get { return ID; } }

    public override string Title { get { return "Place - Resolution Card"; } }
    public override Vector2 DefaultSize { get { return new Vector2(400, 150); } }

    [ValueConnectionKnob("", Direction.In, "CardResolutionType", NodeSide.Left, 30)]
